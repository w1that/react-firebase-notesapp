...
function Login() {
  ...
  return (
    <div style={{ background: "#161616" }} className=" w-full h-screen">
      <span
        style={{ zIndex: "-1", background: "#161616" }}
      ...
      <div className="z-10 flex items-center justify-between w-5/6 sm:w-1/6 bg-gray-600 mt-96 rounded-full mx-auto py-2 pl-3 pr-3">
        ...
        <button
          ...
          className="bg-blue-500 transition duration-400 rounded-full text-white text-2xl px-3 py-1 hover:bg-blue-400 hover:text-gray-700"
        >
          Log in with Google
        </button>
      </div>
